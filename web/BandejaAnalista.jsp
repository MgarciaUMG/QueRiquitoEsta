                ...
                <div class="card-body">
                    <form action="Controlador?menu=BandejaAnalista" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="txtpnombre" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Segundo Nombre</label>
                            <input type="text" name="txtsnombre" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Primer Apellido</label>
                            <input type="text" name="txtpapellido" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Segundo Apellido</label>
                            <input type="text" name="txtsapellido" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Puesto</label>
                        ...
                        <c:forEach var="us" items="${usuarios}">
                            <tr>
                                ...
                                <td class="text-center">
                                    <a class="btn btn-warning" href="Controlador?menu=editar&nit_persona=${us.getNit_persona()}">Editar</a>
                                    <a class="btn btn-danger" href="Controlador?menu=eliminar&nit_persona=${us.getNit_persona()}">Remove</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
